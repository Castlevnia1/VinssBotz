...
let handler = async (m, {
    ...
    if (command == "creator") {
        let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Vinss;Bot;;Md\nFN:Saya Owner Vinss Bot WhatsApp, Md\nNICKNAME:👑 Owner Vinss Bot\nORG:VinssOfc\nTITLE:soft\nitem1.TEL;waid=1(470)6677613:+1 (470) 667 7613\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://lynk.id/kahfi.xd\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:maxxyofc@mail.com\nitem3.X-ABLabel:💌 Mail Owner VinssBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 13 January 2001\nEND:VCARD`
    ...
    if (command == "owner") {
        try {
            let sentMsg = await conn.sendContactArray(m.chat, [
                [nomorown, await conn.getName(nomorown + "@s.whatsapp.net"), "👑 Developer Bot ", "🚫 Dont call me 🥺", "maxxyofc@gmail.com", "🇮🇩 Indonesia", "🚀 https://aygemuy.github.io/", "👤 Gada pawang nih senggol dong 😔"],
